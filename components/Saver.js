    ...
    <section className="bg-white dark:bg-gray-800">
      ...
      <div className="bg-[#F1F1F1] dark:bg-gray-900">
        <div className="px-4 text-container max-w-6xl mx-auto pt-20">
          <p>
            Duduu Studio built the Status Story Saver WhatsApp app as a Free
            app. This SERVICE is provided by Duduu Studio at no cost and is
          ...
          <p>
            ...
            our Terms and Conditions, which are accessible at Status Story Saver
            WhatsApp unless otherwise defined in this Privacy Policy.
          </p>{" "}
          <p>
          ...
          <p>
            ...
            including but not limited to Internet, Storage. The information that
          ...
          <p>This policy is effective as of 2022-02-14</p>{" "}
          <p>
