    ...
    <section className="bg-white dark:bg-gray-800">
      ...
      <div className="bg-[#F1F1F1] dark:bg-gray-900">
        <div className="px-4 text-container max-w-6xl mx-auto pt-20">
          <p>
            Duduu Studio built the Cute Duduu and Friends Sticker app as an Ad
          ...
          <p>
            ...
            our Terms and Conditions, which are accessible at Cute Duduu and
            Friends Sticker unless otherwise defined in this Privacy Policy.
          </p>
          <br />
          <p>
